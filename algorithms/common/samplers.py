...
# ================================ new =====================================
from algorithms.agent import MakeDeterministic
# ==========================================================================
# =============================== rlkit ====================================
...
class InPlacePathSampler(object):
    ...
    def obtain_samples(self, deterministic=False, max_samples=np.inf, max_trajs=np.inf, accum_context=True, resample=1):
        ...
        The resample argument specifies how often (in trajectories) the agents will resample it's context.
        """
...
def rollout(env, agent, max_path_length=np.inf, accum_context=True, animated=False):
    """
    ...
    while path_length < max_path_length:
        ...
        #     image = Image.fromarray(np.flipud(env.render()))
