...
default_config = dict(
    ...
    algo_params=dict(
        ...
        num_traj_per_eval=3, # number of trajectories per eval (added by seunghyun lee, 2trajs for exp + 1traj for meta-test)
        ...
        max_path_length=1000, # max path length for this environment # origin 200 --> 1000 (x5)
